...
const Excel = () => {
    return (
        <div className="excel-container">
            <h1 className="excel-title">Excel Plan</h1>
            <div className="excel-content">
                <p>
                    1. Open Excel file <br />
                    2. All work should be in one sheet <br />
                    3. Create Table 1 for raw data. The title of the table
                    should be “Table 1. Raw Data”. <br />
                ...
                <p>
                    ...
                    experiment. The top cell will contain the parameter’s name
                    and the bottom cells will have the measured numbers. <br />
                ...
                <img src={pic4} alt="" />
                <p>
                    8. Combine two cells in order to make a general for the
                    first two rows. Use “Объединить и переместить в центре”
                    function.
                </p>
                <img src={pic5} alt="" />
                <p>
                    9. Increase the height of cell two times (for example, from
                    15 to 30)
                </p>
                <img src={pic6} alt="" />
                <img src={pic7} alt="" />
                ...
                <img src={pic8} alt="" />
                <p>
                    10. The text should not be one line, so we use wrapping,
                    which called “Перенести текст”.
                </p>
                <img src={pic9} alt="" />
                ...
                <img src={pic12} alt="" />
                <p>
                    13. The next columns will be used for Dependent variable of
                    the experiment. The quantity of columns depends on the
                    number of experiments. Usually, it is equal to 5
                </p>
                <p>
                ...
                <img src={pic13} alt="" />
                <p>
                    15. If the number of experiments is equal to 5, then combine
                    5 cells in the first row. You should use “Объединить и
                    переместить в центре” function, as you did before.
                </p>
                <img src={pic14} alt="" />
                ...
                <img src={pic23} alt="" />
                <p>
                    25. Round of Average DV to the same number of decimal place
                    as Uncertainty in Average DV
                </p>
                <img src={pic24} alt="" />
            </div>
        </div>
