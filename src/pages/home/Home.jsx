    ...
    return (
        <div className="home">
            <section className="hero-section">
                <h1 className="hero-title">Welcome to Science BC</h1>
                <p className="hero-subtitle">
                    Explore the fascinating world of science through interactive lessons, experiments, and real-world applications.
                </p>
                <Link to="/tutorial" className="cta-button">
                    Get Started
                </Link>
            </section>

            <section className="features-section">
                <h2 className="section-title">Why Choose Science BC?</h2>
            ...
            <section className="strands-section">
                <h2 className="section-title">Explore Science Strands</h2>
                <div className="strands-grid">
                    <div className="strand-card">
                        ...
                        <Link to="/strand1" className="strand-link">
                            Learn More
                        </Link>
                    </div>
                    <div className="strand-card">
                        ...
                        <Link to="/strand2" className="strand-link">
                            Learn More
                        </Link>
                    </div>
                    <div className="strand-card">
                        ...
                        <Link to="/strand3" className="strand-link">
                            Learn More
                        </Link>
                    </div>
                </div>
