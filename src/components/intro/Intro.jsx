    ...
    <>
      <div className="intro">
        <div className="intro-text">
          ...
          <p>
            This is for you! On this page, students will learn how to write the
            first part of Criterion C, including table and graph construction,
            uncertainty, data analysis, and more! Watch and get an 8 out of 8!
          </p>
          <Link to="/options">
